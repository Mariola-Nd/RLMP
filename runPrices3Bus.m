...
%For experiments 1-3 please load pglib_opf_case3_lmbdTRIAL3-------

mpc = loadcase('pglib_opf_case3_lmbdTRIAL3');

%--------For experiment 4 please load 'pglib_opf_case3_Exp4'--------------

%mpc = loadcase('pglib_opf_case3_Exp4');  %uncomment this line to run
%experiment 4
